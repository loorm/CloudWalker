...
export const INVERT_ENTRY_SPIN  = 0.55; // seconds for the half-roll entry animation
export const INVERT_WINDOW      = 1.5;  // seconds: tap-window for 5× UP/DOWN invert trigger
export const INVERT_MIN_VX      = 183;  // minimum speed (px/s) to enter inverted flight (~yellow)
